        ...
        <CardContent className="pt-8 flex flex-col items-center justify-center text-center">
          <div className="relative h-40 w-40 mb-6">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span
                className={`text-4xl font-bold ${statusColor} tracking-tighter highlight-contrast px-2 rounded-lg py-1 shadow-lg`}
              >
                {scorePct}%
              </span>
          ...
          <div className="flex flex-col items-center gap-3">
            <Badge
              ...
              className="px-4 py-1.5 text-sm font-semibold shadow-sm highlight-contrast"
            >
              <StatusIcon className="mr-2 h-4 w-4" />
              {decisionLabel}
            </Badge>
            <span className="text-xs font-bold text-foreground uppercase tracking-widest border px-3 py-1 rounded-md bg-background shadow-md highlight-contrast">
